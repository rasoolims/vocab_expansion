...
class Expander:
    ...
    def parse_options():
        ...
        parser.add_option('--dst_emebd', dest='dst_embedding', help='External target word embeddings', metavar='FILE')
        parser.add_option('--pos_emebd', dest='pos_embedding', help='External source pos embeddings', metavar='FILE')
